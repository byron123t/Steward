...
class ParseHtml:
    ...
    def get_interactables(self, clean=True):
        ...
        interactables.extend(self.soup.select('[class*="{}"]'.format('ui-accordion')))
        interactables.extend(self.soup.select('[class*="{}"]'.format('ui-draggable-handle')))
        interactables.extend(self.soup.select('[class*="{}"]'.format('ui-droppable')))
        interactables.extend(self.soup.select('[class*="{}"]'.format('ui-sortable-handle')))
        interactables.extend(self.soup.select('[class*="{}"]'.format('ui-accordion-header-collapsed')))
        interactables.extend(self.soup.select('[class*="{}"]'.format('ui-datepicker-prev')))
        interactables.extend(self.soup.select('[class*="{}"]'.format('ui-datepicker-next')))
        interactables.extend(self.soup.select('[class*="{}"]'.format('ui-slider')))
